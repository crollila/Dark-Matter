...
- `SPRITE_SHEETS` (MULTI-SHEET, each `{path,tile}`): `weapons` (assets/sprites/weapons_black_outline.png), `armor` (assets/sprites/armor.png), `main` (assets/sprites/sheet.png, fallback/general). All 16px tiles.
